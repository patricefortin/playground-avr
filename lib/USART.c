/*
  Humbly copied from Elliot Williams "Make: AVR Programming", with few additions
  See https://github.com/hexagon5un/AVR-Programming/tree/master/AVR-Programming-Library
*/
...
void printInt32(uint32_t value) {
  transmitByte('0' + (value / 10000000000));
  transmitByte('0' + (value / 1000000000));
  transmitByte('0' + (value / 100000000));
  transmitByte('0' + (value / 10000000));
  transmitByte('0' + (value / 1000000));
  transmitByte('0' + (value / 100000));
  transmitByte('0' + (value / 10000));                 /* Ten-thousands */
  transmitByte('0' + ((value / 1000) % 10));               /* Thousands */
  transmitByte('0' + ((value / 100) % 10));                 /* Hundreds */
  transmitByte('0' + ((value / 10) % 10));                      /* Tens */
  transmitByte('0' + (value % 10));                             /* Ones */
  printNewLine();
}
